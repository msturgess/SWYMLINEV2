...
//////////////////////////////////////////////////////////////////////////////////////
	...
	UFUNCTION(BlueprintPure, meta = (DisplayName = "Serial Bytes to Floats"), Category = "Communication Serial", meta = (Keywords = "communication com SERIALCOM duino arduino serial cast concatenate group bit bitwise bytes to float"))
		static TArray<float> BytesToFloats(TArray<uint8> Bytes);
	...
	UFUNCTION(BlueprintPure, meta = (DisplayName = "Serial Floats to Bytes"), Category = "Communication Serial", meta = (Keywords = "communication com SERIALCOM duino arduino serial cast separate bit bitwise flowat to bytes"))
		static TArray<uint8> FloatsToBytes(const TArray<float>& Floats);
	/**
